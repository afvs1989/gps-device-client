        ...
        try {
            ...
            if (!_isGPSEnabled && !_isNetworkEnabled) {
                ...
                if (_isNetworkEnabled) {
                    ...
                    _locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, MIN_TIME_BW_UPDATES, MIN_DISTANCE_CHANGE_FOR_UPDATES, this, Looper.getMainLooper());
